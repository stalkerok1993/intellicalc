 ...
 */
public class Tangent extends Trigonometry {

    public Tangent(String expression, boolean inverse, AngleGrade grade) {
        super(expression, inverse, grade);
    }

    public Tangent(String expression, boolean inverse) {
